...
from repositories import SpeciesRepository, IrisRepository
from services import SpeciesService, IrisService
...
iris_repo = IrisRepository()
species_service = SpeciesService(species_repo)
iris_service = IrisService(iris_repo)
...
def get_columns():
    columns = iris_service.get_available_columns()
    return jsonify(columns)


@app.route("/iris/<name>")
def get_all_by_species(name):
    iris_list = iris_service.get_all_by_species(name)
    return jsonify(iris_list)


@app.route("/iris/<column>/larger_than")
def get_larger_than(column):
    if not iris_service.validate_column(column):
    ...
    iris_list = iris_service.get_larger_than(column, value, n, order)
    return jsonify(iris_list)
...
def get_smaller_than(column):
    ...
    iris_list = iris_service.get_smaller_than(column, value, n, order)
    return jsonify(iris_list)
...
def get_equal_to(column):
    ...
    iris_list = iris_service.get_equal_to(column, value, n)
    return jsonify(iris_list)
...
def get_top_n(column):
    ...
    iris_list = iris_service.get_top_n(column, n, order)
    return jsonify(iris_list)
...
def get_smallest(column):
    ...
    species = request.args.get("species")  # optional filter
    result = iris_service.get_smallest_value(column, species)
...
def get_largest(column):
    ...
    species = request.args.get("species")  # optional filter
    result = iris_service.get_largest_value(column, species)
    return jsonify(result)
...
def get_average(column):
    ...
    species = request.args.get("species")  # optional filter
    result = iris_service.get_average_value(column, species)
    return jsonify(result)
...
def get_median(column):
    ...
    species = request.args.get("species")  # optional filter
    result = iris_service.get_median_value(column, species)
    return jsonify(result)
...
def get_quantile(column):
    ...
    result = iris_service.get_quantile_value(column, q, species)
    return jsonify(result)
